    ...
    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 animate-fade-in">
      ...
      {/* <div className="bg-white/90 backdrop-blur-md border border-slate-100 p-6 rounded-3xl shadow-lg hover:shadow-xl transition-all hover:-translate-y-1">
        ...
        <p className="text-slate-500 mt-2 text-sm leading-relaxed">
          Sube tu certificación del SIRECA y visualiza aquí tu progreso
          académico y los cursos listos para equivalencias.
        </p>
        <button className="mt-4 px-4 py-2 bg-slate-50 text-brand-600 rounded-xl font-semibold hover:bg-brand-50 transition-colors w-full border border-slate-200 truncate">
      ...
      <div className="bg-gradient-to-br from-brand-600 to-indigo-700 text-white p-6 rounded-3xl shadow-lg shadow-brand-500/30 hover:shadow-xl transition-all hover:-translate-y-1">
        ...
        <p className="text-indigo-100 mt-2 text-sm leading-relaxed">
          Envía tus programas certificados para su revisión ágil por la
          secretaría usando plantillas estandarizadas de la USAC.
        </p>
        <button className="mt-4 px-4 py-2 bg-white text-indigo-700 rounded-xl font-bold hover:bg-slate-50 focus:ring-4 focus:ring-indigo-300 transition-all w-full truncate">
      ...
      <div className="bg-white/90 backdrop-blur-md border border-slate-100 p-6 rounded-3xl shadow-lg hover:shadow-xl transition-all hover:-translate-y-1">
        ...
        <ul className="mt-3 space-y-2">
          <li className="flex items-center justify-between text-sm">
            <span className="text-slate-600 font-medium">Enviadas:</span>{" "}
          ...
          <li className="flex items-center justify-between text-sm">
            ...
            <span className="text-amber-500 font-bold bg-amber-50 px-2 py-0.5 rounded-md">
              1
            </span>
          </li>
          <li className="flex items-center justify-between text-sm">
            <span className="text-slate-600 font-medium">Finalizadas:</span>{" "}
            <span className="text-green-500 font-bold bg-green-50 px-2 py-0.5 rounded-md">
              4
            </span>
          </li>
        </ul>
        <button className="mt-4 px-4 py-2 bg-slate-50 text-slate-700 rounded-xl font-semibold hover:bg-slate-100 transition-colors w-full border border-slate-200 text-xs">
          Ver notificaciones
        </button>
      </div> */}
      ...
      <div className="bg-white/90 backdrop-blur-md border border-slate-100 p-6 rounded-3xl shadow-lg hover:shadow-xl transition-all hover:-translate-y-1">
        ...
        <p className="text-slate-500 mt-2 text-sm leading-relaxed">
          Visualiza aquí tu progreso académico y los cursos aprobados.
        </p>
        <button
